...
angular.module('app')
  .run(
    [          '$rootScope', '$state', '$stateParams','$window','AuthenticationService',
      function ($rootScope,   $state,   $stateParams,$window,AuthenticationService) {
          $rootScope.$state = $state;
          $rootScope.$stateParams = $stateParams;    
          $rootScope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams){
              if (!$rootScope.authentication && toState.access.requiredAuthentication && !$window.sessionStorage.idUser){
            	  event.preventDefault();
                  $state.go('access.administrateur');
           }
          });
      }
    ]
  ...
  .config(
    [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG) {
          ...
          $urlRouterProvider
              .otherwise('/access/administrateur');
          $stateProvider
              .state('app', {
                  abstract: true,
                  url: '/app',
              ...
              .state('access.signin', {
               ...
               .state('access.collaborateur', {
                  url: '/collaborateur',
                  templateUrl: 'tpl/pageApp/signinCollab.html',
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['js/controllers/signin.js'] );
               ...
               .state('access.administrateur', {
                  url: '/administrateur',
                  templateUrl: 'tpl/pageApp/signinAdmin.html',
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['js/controllers/signin.js'] );
                ...
                access: { requiredAuthentication: false }
                  ...
                  url: '/manager',
                  templateUrl: 'tpl/pageApp/signinManager.html',
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['js/controllers/signin.js'] );
